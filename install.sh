...
git clone --depth 1 --quiet https://github.com/brayancorrea-blip/dev-standard.git "$TMPDIR/dev-standard"
...
bash "$TMPDIR/dev-standard/setup-dev-standard.sh" $SETUP_ARGS
